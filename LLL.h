...
class Matrix;										// Matrix class is created for work with lattice basis (prototype)
void LLL(Matrix& X, double delta = 0.75);						// LLL algorithm realization (prototype of function)
